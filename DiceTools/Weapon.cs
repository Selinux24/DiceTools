...
namespace DiceTools
{
    ...
    public class Weapon
    {
        public static int CalcShoots(WeaponTypes type, float range, float distance, int dice, int rolls)
        {
        ...
        {
            return CalcShoots(Type, Range, distance, AttackDice, Attacks);
        }
